...
public class CustomerVisitSchedule extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustomerVisitSchedule frame = new CustomerVisitSchedule();
	 ...
	 * Create the frame.
	 */
	public CustomerVisitSchedule() {
		
	}
	public CustomerVisitSchedule(String cid) {
